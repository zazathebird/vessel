...
Object, `src/share/*`, and the `/share` + `/machines` pages. Harness is at **260**. The docs
...
> all 260 checks pass before anything else.
>
...
- **The harness is at 260** and covers every route end to end, negatives included. It cannot
