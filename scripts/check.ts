 ...
 */
let sharingLock: Promise<unknown> = Promise.resolve();
 ...
 */
async function sqliteD1(): Promise<{ db: D1Database; raw: { prepare(sql: string): { get(...a: unknown[]): unknown; run(...a: unknown[]): unknown } } }> {
